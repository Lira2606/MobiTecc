...
export function DeliveryForm({ onSubmit }: DeliveryFormProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-2xl tracking-tight">Nova Entrega</CardTitle>
        <CardDescription>Preencha os detalhes para registrar uma entrega.</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
              ...
              <div className="space-y-4">
                ...
                {photoDataUri ? (
                  <div className="relative group aspect-video">
                    <Image src={photoDataUri} alt="Foto da entrega" layout="fill" className="rounded-md object-cover" />
